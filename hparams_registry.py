...
def _hparams(algorithm, dataset, random_seed):
    ...
    elif algorithm == 'MSFP_CCFP':
        _hparam('lambda_sem', 0.5, lambda r: 10**r.uniform(-1, 1))
        _hparam('lambda_dis', 0.1, lambda r: 10**r.uniform(-1, 1))
        _hparam('lambda_shallow', 0.33, lambda r: r.uniform(0.1, 0.5))
        _hparam('lambda_mid', 0.33, lambda r: r.uniform(0.1, 0.5))
        _hparam('lambda_deep', 0.34, lambda r: r.uniform(0.1, 0.5))
        _hparam('epsilon_shallow', 0.1, lambda r: 10**r.uniform(-2, -0.3))
        _hparam('epsilon_mid', 0.1, lambda r: 10**r.uniform(-2, -0.3))
        _hparam('epsilon_deep', 0.1, lambda r: 10**r.uniform(-2, -0.3))
